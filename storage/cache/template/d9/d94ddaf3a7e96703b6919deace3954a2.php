...
/* dashboard/view/template/tool/upload.twig */
class __TwigTemplate_c19dacfca8358db7a4d53a6e45e85469 extends Template
{
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"float-end\">
        ...
        yield "\" onclick=\"\$('#filter-upload').toggleClass('d-none');\" class=\"btn btn-light d-md-none\"><i class=\"fa-solid fa-filter\"></i></button>
...
\$('#form-filter').on('submit', function(e) {
    ...
    \$('#list').load('index.php?route=tool/upload.list&user_token=";
        // line 63
...
";
    ...
    {
        return "dashboard/view/template/tool/upload.twig";
    }
    ...
    {
        return array (  180 => 66,  174 => 63,  155 => 47,  151 => 46,  140 => 38,  136 => 37,  128 => 34,  124 => 33,  116 => 30,  112 => 29,  104 => 26,  100 => 25,  93 => 21,  84 => 14,  73 => 12,  69 => 11,  64 => 9,  55 => 7,  51 => 6,  42 => 1,);
    }
...
\$('#form-filter').on('submit', function(e) {
    ...
    \$('#list').load('index.php?route=tool/upload.list&user_token={{ user_token }}&' + \$(this).serialize());
});
//--></script>
{{ footer }}", "dashboard/view/template/tool/upload.twig", "D:\\xampp\\htdocs\\www\\opencartly\\dashboard\\view\\template\\tool\\upload.twig");
    }
}
