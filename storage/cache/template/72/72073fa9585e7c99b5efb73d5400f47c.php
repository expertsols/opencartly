...
/* dashboard/view/template/catalog/filter_list.twig */
class __TwigTemplate_0d249ef0712488de86a2a37039212901 extends Template
{
  ...
  <div class=\"row\">
    ...
    {
        return "dashboard/view/template/catalog/filter_list.twig";
    }
    ...
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
          ...
          <th><a href=\"{{ sort_name }}\"{% if sort == 'fgd.name' %} class=\"{{ order|lower }}\"{% endif %}>{{ column_filter_group }}</a></th>
...
</form>", "dashboard/view/template/catalog/filter_list.twig", "D:\\xampp\\htdocs\\www\\opencartly\\dashboard\\view\\template\\catalog\\filter_list.twig");
    }
}
